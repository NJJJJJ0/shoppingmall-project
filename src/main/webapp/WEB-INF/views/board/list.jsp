...
function list(page){
location.href="/board/list.do?curPage="+page+"&search_option=${map.search_option}&keyword=${map.keyword}";
}
</script>
...
<table border="1" style='width=600px;table-layout:fixed;word-break:break-all; height:auto'>
...
<td><a href="/board/detail.do?idx=${row.idx}&cur_page=${map.page_info.curPage}&search_option=${map.search_option}&keyword=${map.keyword}">${row.title}</a>
<c:if test="${row.cnt  > 0}">
