...
function product_delete(){
	if(confirm("삭제하시겠습니까?")){
		document.form1.action="/product/product/delete.do";
...
function product_update(){
	...
	var price=docuent.form1.price.value;
	...
	document.form1.action="/product/product/update.do";
	document.form1.submit();
}
</script>
</head>
...
<td>상품이미지</td>
<td>
<img src="/resources/images/${dto.filename}" width="300px" height="300px">
<br>
...
<input type="button" value="목록" onclick="location.href='/product/product/list'">
</td>
</tr>
</table>
</form>
